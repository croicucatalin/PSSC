...
namespace Models.Subject
{
    ...
    public class Subject
    {
        ...
        {
            SubjectSituation situation = _signedUpStudentsGrades.First(d => d.Key.Reg_Number == regNumber).Value;
        ...
        {
            return _signedUpStudentsGrades.First(d => d.Key.Reg_Number == regNumber).Value;
        }
    }
}
